...
Cada componente desempenha uma diferente fun{\c c}\~ao de forma a processar a informação advinda da corrente fotogerada por \emph{Photodiode}:
...
\begin{figure}[htb]
	...
	\end{center}
	\legend{Fonte do esbo{\c c}o: Pr\'oprio autor}
\end{figure}
