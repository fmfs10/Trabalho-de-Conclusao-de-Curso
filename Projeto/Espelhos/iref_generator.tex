...
\begin{figure}[htb]
 \centering
    ...
    \legend{Fonte: Produzido pelo autor}
    \nota{Nem todos transistores são representados na imagem. \emph{Q17}, \emph{Q18}, \emph{Q19} e \emph{Q20} s\~ao transistores replicados para cada sa\'ida \emph{IrefX\_src} e \emph{IrefY\_sink}, onde \emph{X} e \emph{Y} s\~ao os identificadores de cada sa\'ida}
    \label{\NomePFig}
\end{figure}
