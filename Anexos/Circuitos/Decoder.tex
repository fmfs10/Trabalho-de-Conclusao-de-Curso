...
O bloco \NomeBloco{} tem a fun ção de colocar um bit '1' em uma das sa\'idas, enquanto todas outras são iguais a '0'. A \autoref{\NomePTab} indica a Tabela Verdade do bloco.
...
\begin{tabular}{ccl}
    ...
    \midrule \midrule
    In1    & Entrada & Primeira entrada de sele ção de sa\'ida \\
    \midrule
    In2    & Entrada & Segunda entrada de sele ção de sa\'ida \\
    \midrule
